...
// Procura um elemento pelo valor (converte o valor para array e depois utiliza o método includes())
...
// Retorna o valor armazenado na chave 3 (Procura um valor com base na chave)
